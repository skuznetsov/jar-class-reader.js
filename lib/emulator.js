        ...
        while(!this.codeReader.EOF) {
            ...
            switch(instruction) {
                ...
                case OPCODES.OP_getstatic:
                    index = this.codeReader.readUShort();
                    if (isFieldListeners) {
                        this.emit('field_access', method, this.classData.getConstantPool().resolve(index));
                    }
                    break;
                ...
                case OPCODES.OP_invokevirtual:
                    index = this.codeReader.readUShort();
                    data = this.classData.getConstantPool().resolve(index);
                    thisClass = this.classData.getClassName();
